...
namespace Student_Application.Controllers
{
    ...
    {
        private readonly Student_ApplicationContext _context;

        public RegistersController(Student_ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Register != null ? 
                          ...
                          Problem("Entity set 'Student_ApplicationContext.Register'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Student_ApplicationContext.Register'  is null.");
            }
            var register = await _context.Register.FindAsync(id);
            if (register != null)
            {
