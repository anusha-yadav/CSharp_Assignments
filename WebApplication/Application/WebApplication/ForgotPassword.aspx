    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="margin-left: auto; margin-right: auto;">
                ...
                <tr>
                    <td>
                        <asp:HyperLink ID="Login" runat="server" Text="Back to Login" NavigateUrl="~/Login.aspx"></asp:HyperLink>
                    </td>
                    <td colspan="2">
                        <asp:Button ID="buttonPasswd" runat="server" Text="Submit" OnClick="ForgotPassword_Button" />
                    </td>
                </tr>
                <tr>
                    <td></td>
